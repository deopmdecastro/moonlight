...
function buildBaseEmailVars(extra = {}) {
  ...
  const instagramUrl = storeInstagram
    ...
    : ''
  const instagramIconUrl = base ? `${base}/icons/instagram.svg` : ''
  const instagramSection = instagramUrl
    ? [
        '<table role="presentation" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">',
        '  <tr>',
        '    <td style="padding:0 10px 0 0;vertical-align:middle;">',
        `      <a href="${escapeHtml(instagramUrl)}" style="text-decoration:none;">`,
        `        <img src="${escapeHtml(instagramIconUrl)}" width="18" height="18" alt="Instagram" style="display:block;border:0;outline:none;text-decoration:none;"/>`,
        '      </a>',
        '    </td>',
        '    <td style="vertical-align:middle;font-size:12px;line-height:1.6;color:#7e676f;word-break:break-word;overflow-wrap:anywhere;">',
        `      <a href="${escapeHtml(instagramUrl)}" style="color:#782641;text-decoration:underline;">Instagram</a>`,
        '    </td>',
        '  </tr>',
        '</table>',
      ].join('')
  ...
  return {
    ...
    instagram_icon_url: instagramIconUrl,
...
const defaultEmailContent = {
  ...
  welcome: {
    ...
    html: [
      ...
      '          </tr>',
      '          <tr>',
      '            <td style="background:#fbfaf8;border:1px solid #e0d9d1;border-radius:12px;padding:26px 22px;word-break:break-word;overflow-wrap:anywhere;">',
      ...
      '              <p style="margin:0 0 6px 0;font-size:12px;line-height:1.6;color:#7e676f;word-break:break-word;overflow-wrap:anywhere;">',
  ...
  campaign: {
    ...
    html: [
      ...
      '              </table>',
      '              <hr style="border:none;border-top:1px solid #e0d9d1;margin:20px 0;"/>',
      '              <p style="margin:0 0 8px 0;font-size:12px;line-height:1.6;color:#7e676f;word-break:break-word;overflow-wrap:anywhere;">',
      '                Se não quiser receber mais emails, pode cancelar aqui: <a href="{{unsubscribe_url}}" style="color:#782641;text-decoration:underline;word-break:break-word;overflow-wrap:anywhere;">Cancelar subscrição</a>',
      '              </p>',
      '              <p style="margin:0 0 6px 0;font-size:12px;line-height:1.6;color:#7e676f;word-break:break-word;overflow-wrap:anywhere;">',
      '                <strong style="color:#3d2930;">{{store_name}}</strong> {{store_address}}',
      '              </p>',
...
app.post('/api/admin/smtp/test', async (req, res) => {
  ...
  try {
    ...
    const instagramBlock = vars.instagram_url
      ? [
          '<table role="presentation" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">',
          '  <tr>',
          '    <td style="padding:0 10px 0 0;vertical-align:middle;">',
    ...
    const html = renderTemplate(
      [
        ...
        '              <h1 style="margin:0 0 10px 0;font-size:22px;line-height:1.25;color:#3d2930;font-weight:700;">Teste de Email</h1>',
        '              <p style="margin:0 0 18px 0;font-size:14px;line-height:1.6;color:#3d2930;">',
        '                Este email confirma que o envio SMTP está a funcionar.',
        '              </p>',
        '              <div style="background:#f8f5f1;border:1px solid #e0d9d1;border-radius:10px;padding:12px 12px;margin:0 0 18px 0;">',
        '                <div style="font-size:12px;color:#7e676f;line-height:1.5;">Mensagem</div>',
        '                <div style="margin-top:6px;font-size:13px;line-height:1.7;color:#3d2930;word-break:break-word;overflow-wrap:anywhere;">{{message_html}}</div>',
        '              </div>',
        '              <table role="presentation" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">',
        '                <tr>',
        '                  <td style="background:#782641;border:1px solid #782641;border-radius:0;">',
